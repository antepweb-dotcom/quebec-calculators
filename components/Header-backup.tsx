            ...
            <div className="p-4 border-t border-gray-100 bg-white safe-area-bottom">
              <div className="grid grid-cols-2 gap-3">
                <Link 
                  href="/simulateur-vie-quebec"
                  onClick={() => setIsMobileMenuOpen(false)}
                  className="flex flex-col items-center justify-center gap-1.5 py-3 bg-gradient-to-r from-purple-600 to-blue-600 text-white font-bold rounded-xl active:scale-[0.98] transition-transform shadow-lg"
                >
                ...
                <Link 
                  href="/salaire-net-quebec"
                  onClick={() => setIsMobileMenuOpen(false)}
                  className="flex flex-col items-center justify-center gap-1.5 py-3 bg-slate-900 text-white font-bold rounded-xl active:scale-[0.98] transition-transform"
                >
                  <Calculator className="w-5 h-5" />
                  <span className="text-xs">Salaire Net</span>
                </Link>
              </div>
            </div>
          </motion.div>
