      ...
      <div className="bg-white py-8 border-y border-slate-200">
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-center items-center gap-6 md:gap-12 max-w-3xl mx-auto">
            ...
            <div className="text-center">
              <div className="text-xl md:text-2xl font-bold text-slate-800 mb-0.5">14+</div>
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <div className="bg-slate-50 rounded-2xl p-8 border border-slate-200">
              ...
              <div className="grid md:grid-cols-3 gap-6 text-sm text-slate-700">
                ...
                <div>
                  <h4 className="font-bold text-slate-900 mb-2">Outils Complets</h4>
                  <p>Salaire, hypothèque, REER, CELI, prêts auto et étudiants, frais de garde, TPS/TVQ, assurance-emploi, et plus encore.</p>
                </div>
              </div>
            </div>
          </div>
